...
SEPOLICY_PATH := $(QCOM_COMMON_PATH)/sepolicy/sepolicy_vndr
QSSI_SEPOLICY_PATH := $(QCOM_COMMON_PATH)/sepolicy/qssi
BOARD_SYSTEM_EXT_PREBUILT_DIR := $(QSSI_SEPOLICY_PATH)/generic
BOARD_PRODUCT_PREBUILT_DIR := $(QSSI_SEPOLICY_PATH)/generic/product
